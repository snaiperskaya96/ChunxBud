...
python2 /opt/esp-open-sdk-gcc8/xtensa-lx106-elf/bin/esptool.py -p /dev/ttyUSB0 -b 1500000 write_flash -ff 40m -fm qio -fs 4M 0x2000 out/Esp8266/debug/firmware/rom0.bin # flash rom0 on slot 0